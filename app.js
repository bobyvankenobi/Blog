...
//homepage -> renders home.ejs with starting content and fetches db content
...
//compose endpoint -> renders input form
app.get("/compose", function(request, response){
  response.render("compose");
});

//compose post -> catches compose post and saves into mongoDB atlas
...
//checks for posts/custom_endpoint and looks for it if it exists
